        ...
        <Container size="7xl" className="relative z-10">
          ...
          <div className="flex justify-center">
             <a href="https://divistant.com/career" target="_blank" rel="noopener noreferrer">
                <Button size="lg" className="h-14 px-10 text-lg font-bold bg-white text-slate-900 dark:text-slate-900 dark:text-white hover:bg-slate-100 border-none shadow-xl hover:shadow-indigo-500/20 transition-all rounded-full">
      ...
      <section className="py-24 bg-slate-900 relative overflow-hidden">
         ...
         <Container size="7xl" className="text-center relative z-10">
            ...
            <Stack direction="vertical" gap={6} className="justify-center">
               <a href="https://divistant.com/career" target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="h-16 px-12 text-lg font-bold bg-white text-slate-900 dark:text-slate-900 dark:text-white hover:bg-slate-100 border-none shadow-2xl hover:shadow-white/20 transition-all rounded-2xl w-full sm:w-auto">
