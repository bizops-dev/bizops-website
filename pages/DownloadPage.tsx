          ...
          <Grid cols={2} gap={16} className="items-center">
            ...
            <div className="relative z-10">
              ...
              <Stack direction="vertical" gap={4} className="mb-10">
                 <a href="#" className="flex items-center gap-3  bg-slate-900 dark: bg-white  text-white dark:text-white dark:text-white dark: text-white px-6 py-3.5 rounded-xl hover:opacity-90 transition-opacity shadow-xl">
