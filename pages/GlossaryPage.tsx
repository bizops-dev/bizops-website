           ...
           {glossaryData.map((item, idx) => (
              <div key={idx} className="p-8 rounded-2xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-lg hover:border-primary-100 transition-all group">
                 <Stack direction="horizontal" gap={4} align="center" className="mb-4">
                    <Stack direction="horizontal" gap={4} align="center" justify="center" className="w-12 h-12 bg-white rounded-lg font-bold text-2xl text-primary-600 border border-slate-200 shadow-sm group-hover:bg-primary-600 group-hover: text-slate-900 dark:text-white transition-colors">
                       {item.char}
                    </Stack>
