  ...
  return (
    <div className="pt-16 pb-24 bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Ekosistem yang Saling Terhubung.</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         ...
         <div className="mt-24 text-center bg-white p-12 rounded-3xl border border-slate-200 shadow-sm">
