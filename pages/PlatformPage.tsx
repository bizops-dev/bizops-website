      ...
      <Section className="py-20 md:py-32">
         <Grid cols={2} gap={16} className="items-center">
                     ...
                     <Stack direction="horizontal" gap={4}>
                        ...
                        <Stack direction="vertical" gap={4} align="center" justify="center" className="w-2/3 bg-slate-950 rounded-xl border border-slate-800 border-dashed p-4 text-center">
                           <div className="w-full bg-slate-900 rounded-lg p-3 mb-3 text-left">
                              <div className="text-[10px] text-blue-400 dark:text-blue-300 mb-1">Field Label</div>
                              <div className="h-6 bg-slate-800 rounded w-full"></div>
                           </div>
                           <div className="w-full bg-slate-900 rounded-lg p-3 text-left">
                              <div className="text-[10px] text-blue-400 dark:text-blue-300 mb-1">Options</div>
                              <div className="h-6 bg-slate-800 rounded w-full"></div>
                           </div>
                           <div className="mt-4 text-xs text-slate-500 dark:text-slate-400 dark:text-slate-300">Preview Form Layout</div>
                        </Stack>
                     </Stack>
                  </Stack>
            ...
            <div className="order-1 lg:order-2">
               ...
               <Typography variant="body-lg" className="text-slate-600 dark:text-slate-400 dark:text-slate-300 leading-relaxed">Berdayakan tim operasional Anda untuk menjadi <b>Citizen Developer</b>. Dengan BizOps Studio, siapa pun bisa membuat form digital, workflow approval, dan laporan kustom hanya dengan drag-and-drop.</Typography>
               ...
               <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                     <Stack direction="horizontal" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-purple-100 dark:bg-purple-900/20 mt-1">
                        <Layout className="w-5 h-5 text-purple-600 dark:text-purple-400 dark:text-purple-300" />
                     </Stack>
                     <div>
                        <Typography variant="h4" as="h4">Visual Form Builder</Typography>
                        <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Desain form input data kompleks dengan validasi logic, perhitungan otomatis, dan relasi antar data tanpa menulis satu baris kode pun.</Typography>
                     </div>
                  </li>
                  <li className="flex items-start gap-4">
                     <Stack direction="horizontal" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/20 mt-1">
                        <GitBranch className="w-5 h-5 text-blue-600 dark:text-blue-400 dark:text-blue-300" />
                     </Stack>
                     <div>
                        <Typography variant="h4" as="h4">Workflow Automation</Typography>
                        <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Atur alur persetujuan (approval) bertingkat, notifikasi email/WA otomatis, dan trigger aksi berdasarkan perubahan status dokumen.</Typography>
                     </div>
                  </li>
                  <li className="flex items-start gap-4">
                     <Stack direction="horizontal" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/20 mt-1">
                        <Smartphone className="w-5 h-5 text-emerald-600 dark:text-emerald-400 dark:text-emerald-300" />
                     </Stack>
                     <div>
                        <Typography variant="h4" as="h4">Instant Mobile App</Typography>
                        <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Setiap aplikasi yang Anda buat otomatis tersedia di mobile app (iOS/Android) dengan dukungan offline mode untuk pekerja lapangan.</Typography>
                     </div>
                  </li>
               </ul>
            </div>
                  ...
                  {integrationsData.map((cat, idx) => (
                     <div key={idx} className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700/50 backdrop-blur-sm hover:bg-slate-800 hover:border-slate-600 transition-colors group">
                        <Stack direction="horizontal" gap={4} align="center" justify="between" className="mb-4">
                           ...
                           <Share2 className="w-4 h-4 text-slate-600 dark:text-slate-300 group-hover:text-primary-400 transition-colors"/>
                        </Stack>
                        <ul className="space-y-3">
               ...
               {[
                  ...
                  <div key={tech.name} className="flex flex-col items-center gap-3 group cursor-default p-4 rounded-2xl hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg transition-all duration-300 w-28 md:w-32 border border-transparent hover:border-slate-200 dark:hover:border-slate-700">
                     ...
                     <div>
                        ...
                        <div className="text-[10px] text-slate-400 dark:text-slate-300 font-medium mt-0.5">{tech.desc}</div>
                     </div>
                  </div>
               ))}
            </Stack>
