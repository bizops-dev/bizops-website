            ...
            <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] p-6 lg:p-10 shadow-2xl overflow-hidden relative">
               ...
               >
                  ...
                  <Grid cols={12} gap={4} className="p-6 pt-16 h-full bg-slate-900 relative">
                     ...
                     {/* Left Sidebar */}
                     <Stack direction="vertical" gap={2} className="col-span-2 hidden border-r border-slate-800 pr-4 relative z-10">
                     ...
                     <Grid cols={3} gap={4} className="col-span-12 lg:col-span-10 relative z-10">
                        ...
                        <div className="col-span-2 h-64 bg-slate-800 rounded-xl border border-slate-700/50 relative overflow-hidden p-5 hover:border-slate-600 transition-colors">
                           ...
                           <Stack direction="horizontal" gap={2} align="end" justify="between" className="h-36 px-1">
      ...
      <Section className="relative border-t border-white/5 py-16 md:py-24 overflow-hidden">
         ...
         <Container size="7xl" className="relative z-10">
            <div className="text-center mb-12 md:mb-20">
               <Stack direction="horizontal" gap={2} align="center" className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-slate-300 text-xs font-bold uppercase tracking-wider mb-6 backdrop-blur-sm">
            ...
            <CardSlider desktopClassName="md:block md:space-y-6" mobileItemWidth="w-[85vw] sm:w-[400px]">
               {data.challenges?.map((item: any, idx: number) => (
                  ...
                  >
                     ...
                     <Stack direction="vertical" gap={4} className="p-8 md:p-12 border-b md:border-b-0 md:border-r border-white/5 bg-gradient-to-br from-[#1a0505] via-[#0f0303] to-[#050101] relative overflow-hidden group-hover:from-[#2b0a0a] transition-colors duration-500 h-full">
                        {/* Chaos Noise/Texture */}
                     ...
                     <Stack direction="vertical" gap={4} className="p-8 md:p-12 bg-gradient-to-bl from-[#022c22] via-[#011c16] to-[#050101] relative overflow-hidden group-hover:from-[#033d2e] transition-colors duration-500 h-full">
                        {/* Clarity Texture */}
