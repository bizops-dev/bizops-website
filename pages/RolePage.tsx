    ...
    <div className="flex flex-col">
      ...
      <section className="bg-slate-900 py-24 text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-8 leading-tight">{data.heroHeadline}</h1>
      ...
      <section className="py-20 bg-white">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8 lg:p-12 shadow-xl overflow-hidden relative">
               <div className="text-center mb-12 relative z-10">
                  ...
                  <h2 className="text-3xl font-bold text-slate-900 mb-6 max-w-2xl mx-auto leading-snug">
               ...
               <div className="mt-12 bg-white rounded-t-xl border-t border-x border-slate-200 shadow-2xl max-w-5xl mx-auto h-[400px] relative overflow-hidden group">
                  ...
                  <div className="p-8 grid grid-cols-3 gap-6 opacity-40 group-hover:opacity-100 transition-opacity duration-700">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                     <span className="bg-slate-900/80 text-white px-6 py-3 rounded-full backdrop-blur-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
      ...
      <section className="py-24 bg-slate-50">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center text-slate-900 mb-16">Why Leaders Choose BizOps</h2>
            
            <div className="space-y-12">
               {data.challenges?.map((item: any, idx: number) => (
                  <div key={idx} className="bg-white rounded-3xl p-0 shadow-sm border border-slate-200 overflow-hidden flex flex-col md:flex-row group hover:shadow-md transition-shadow">
                     {/* Pain Side */}
      ...
      <section className="py-24 bg-white border-t border-slate-100 text-center">
         <div className="max-w-3xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-slate-900 mb-6">{data.cta?.head}</h2>
            <Link to="/demo">
