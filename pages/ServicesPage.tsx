                          ...
                          <Stack direction="vertical" gap={4} className="relative z-10 h-full">
                              ...
                              <div className="mt-auto">
                                <Link to={`/services/${service.id}`} className="block w-full">
                                  <Button className="bg-white text-slate-900 dark:text-slate-900 dark:text-white hover:bg-slate-200 border-none font-bold px-8 w-full">
                                      Explore
                                  </Button>
                                </Link>
                              </div>
                            ...
                            <Stack direction="vertical" gap={4}>
                               ...
                               <div className="mt-auto">
                                  <Link to={`/services/${service.id}`} className="block w-full md:w-auto">
                                    <Button className="bg-white text-slate-900 dark:text-slate-900 dark:text-white hover:bg-slate-200 border-none font-bold px-8 w-full md:w-auto">
                                       Explore Strategy
                                    </Button>
                                  </Link>
                               </div>
