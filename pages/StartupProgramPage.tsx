    ...
    <div className="flex flex-col">
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-950 transition-colors">
         <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
               <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Pilih Track Anda</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               {/* VC-Backed Track */}
               <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border-2 border-primary-500 shadow-xl relative overflow-hidden">
      ...
      <section className="py-24 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white text-center mb-16">Why Startups Need BizOps Early?</h2>
