...
import { Shield, Lock, Eye, Server, FileCheck, Database, Layers, Globe, CheckCircle, Clock, RefreshCw, AlertTriangle, Download, FileText, ChevronRight } from 'lucide-react';
...
const TrustPage: React.FC = () => {
  return (
    <div className="bg-slate-50 dark:bg-slate-950 transition-colors font-sans selection:bg-emerald-500/30">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 bg-[#0B1120] text-white overflow-hidden py-16 md:py-24">
        ...
        <Container size="5xl" className="relative z-10 text-center">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-900/30 border border-emerald-800 backdrop-blur-md text-emerald-400 dark:text-emerald-300 text-xs font-bold uppercase tracking-wider mb-8"
          >
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
         <Container size="7xl" className="py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs text-slate-500 dark:text-slate-400 dark:text-slate-300">
               ...
               <Link to="/status" className="text-emerald-600 dark:text-slate-300 hover:underline">View History &rarr;</Link>
            </div>
         </Container>
      </div>
      ...
      <Container size="7xl" className="py-24 space-y-32">
        ...
        <section>
           <div className="text-center mb-16">
              ...
              <Typography variant="body" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Kami diaudit secara berkala oleh pihak ketiga independen untuk memastikan standar keamanan tertinggi.</Typography>
           </div>
              ...
              <CardSlider mobileItemWidth="w-[60vw] sm:w-[250px]">
                 ...
                 <div className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-emerald-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center gap-4">
                    <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform gap-4">
                       <Shield className="w-8 h-8 text-slate-700 dark:text-slate-300 group-hover:text-emerald-500 dark:text-emerald-400 dark:text-emerald-300 transition-colors" />
                    </div>
                    <Typography variant="h3" as="h3">ISO 27001</Typography>
                    <Typography variant="body" className="text-slate-500 dark:text-slate-400 dark:text-slate-300">Information Security Management</Typography>
                    <span className="mt-auto inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 dark:text-emerald-300 text-[10px] font-bold uppercase tracking-wide">
                       Certified
                    </span>
                 </div>
                 ...
                 <div className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center gap-4">
                    <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform gap-4">
                       <Globe className="w-8 h-8 text-slate-700 dark:text-slate-300 group-hover:text-blue-500 dark:text-blue-400 dark:text-blue-300 transition-colors" />
                    </div>
                    <Typography variant="h3" as="h3">GDPR & UU PDP</Typography>
                    <Typography variant="body" className="text-slate-500 dark:text-slate-400 dark:text-slate-300">Data Privacy Compliance</Typography>
                    <span className="mt-auto inline-flex items-center gap-1 px-2 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 dark:text-blue-300 text-[10px] font-bold uppercase tracking-wide">
                       Compliant
                    </span>
                 </div>
                 ...
                 <div className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-red-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center gap-4">
                    <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform gap-4">
                       <FileCheck className="w-8 h-8 text-slate-700 dark:text-slate-300 group-hover:text-red-500 dark:text-red-400 dark:text-red-300 transition-colors" />
                    </div>
                    <Typography variant="h3" as="h3">PSE Kominfo</Typography>
                    <Typography variant="body" className="text-slate-500 dark:text-slate-400 dark:text-slate-300">Terdaftar Resmi</Typography>
                    <span className="mt-auto inline-flex items-center gap-1 px-2 py-1 rounded-full bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 dark:text-red-300 text-[10px] font-bold uppercase tracking-wide">
                       Registered
                    </span>
                 </div>
                 ...
                 <div className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-purple-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center opacity-75 gap-4">
                    ...
                    <Typography variant="body" className="text-slate-500 dark:text-slate-400 dark:text-slate-300">Security Controls</Typography>
                    <span className="mt-auto inline-flex items-center gap-1 px-2 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 dark:text-slate-300 text-[10px] font-bold uppercase tracking-wide">
                       In Progress
                    </span>
                 </div>
              </CardSlider>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-16 items-center py-16 md:py-24">
           <div>
              ...
              <Typography variant="body-lg" className="text-slate-600 dark:text-slate-400 dark:text-slate-300 leading-relaxed">Kami tidak hanya mengandalkan satu kunci pintu. Data Anda dilindungi oleh berbagai lapisan keamanan mulai dari fisik, jaringan, aplikasi, hingga level data itu sendiri.</Typography>
              ...
              <div className="lg:hidden">
                 <CardSlider mobileItemWidth="w-[85vw] sm:w-[400px]" breakpoint="lg">
                    <div className="flex gap-4 p-4 border border-transparent hover:border-emerald-500/30 rounded-xl transition-colors">
                       <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center flex-shrink-0 text-emerald-600 dark:text-slate-300 gap-4">
                          <Database className="w-5 h-5" />
                       </div>
                       <div>
                          <Typography variant="h3" as="h3">Encryption at Rest & Transit</Typography>
                          <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Semua data database dienkripsi menggunakan AES-256. Komunikasi data menggunakan TLS 1.3 terbaru.</Typography>
                       </div>
                    </div>
                    <div className="flex gap-4 p-4 border border-transparent hover:border-blue-500/30 rounded-xl transition-colors">
                       <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0 text-blue-600 dark:text-slate-300 gap-4">
                          <Server className="w-5 h-5" />
                       </div>
                       <div>
                          <Typography variant="h3" as="h3">Infrastructure Isolation</Typography>
                          <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Setiap tenant Enterprise berjalan di container terisolasi (Virtual Private Cloud). Data Anda tidak bercampur dengan klien lain.</Typography>
                       </div>
                    </div>
                    <div className="flex gap-4 p-4 border border-transparent hover:border-amber-500/30 rounded-xl transition-colors">
                       <div className="w-10 h-10 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center flex-shrink-0 text-amber-600 dark:text-slate-300 gap-4">
                          <Eye className="w-5 h-5" />
                       </div>
                       <div>
                          <Typography variant="h3" as="h3">24/7 Threat Monitoring</Typography>
                          <Typography variant="caption" className="text-slate-600 dark:text-slate-400 dark:text-slate-300">Tim Security Operations Center (SOC) kami memantau anomali traffic dan upaya intrusi secara real-time.</Typography>
                       </div>
                    </div>
                 </CardSlider>
              </div>
               ...
               <div className="aspect-square bg-slate-900 rounded-[2.5rem] p-6 sm:p-10 relative overflow-hidden shadow-2xl border border-slate-800">
                  ...
                  <Stack direction="vertical" gap={4} className="relative z-10 h-full justify-center">
                      <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl flex items-center justify-between gap-4">
                         <div className="flex items-center gap-3 text-emerald-400 dark:text-emerald-300 text-xs">
                      ...
                      <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl flex items-center justify-between ml-4 sm:ml-8 gap-4">
                         <div className="flex items-center gap-3 text-blue-400 dark:text-blue-300 text-xs">
                      ...
                      <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl flex items-center justify-between ml-8 sm:ml-16 gap-4">
                         <div className="flex items-center gap-3 text-purple-400 dark:text-purple-300 text-xs">
                     ...
                     <table className="w-full text-left text-sm min-w-[600px]">
                        ...
                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                           <tr>
                              ...
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Cloud Infrastructure (Compute & Storage)</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Jakarta (asia-southeast2)</td>
                           </tr>
                           <tr>
                              <td className="p-4 font-medium text-slate-900 dark:text-white">Amazon Web Services (S3)</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Encrypted Backup Storage</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Singapore (ap-southeast-1)</td>
                           </tr>
                           <tr>
                              <td className="p-4 font-medium text-slate-900 dark:text-white">Cloudflare</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">WAF, DDoS Protection, CDN</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Global (Anycast)</td>
                           </tr>
                           <tr>
                              <td className="p-4 font-medium text-slate-900 dark:text-white">Sentry</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">Error Tracking (No PII Data)</td>
                              <td className="p-4 text-slate-600 dark:text-slate-400 dark:text-slate-300">USA</td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
