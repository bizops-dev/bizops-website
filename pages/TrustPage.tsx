    ...
    <div className="bg-slate-50 dark:bg-slate-950 transition-colors font-sans selection:bg-emerald-500/30">
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
         <Container size="7xl" className="py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <Stack direction="row" gap={3} align="center">
               <Stack direction="row" gap={4} className="relative h-3 w-3">
            ...
            <Stack direction="row" gap={6} align="center" className="text-xs text-slate-500 dark:text-slate-400">
      ...
      <Container size="7xl" className="py-24 space-y-32">
        ...
        <section>
           ...
           <div className="md:hidden">
              <CardSlider mobileItemWidth="w-[60vw] sm:w-[250px]">
                 {/* ISO 27001 */}
                 <Stack direction="col" gap={4} align="center" className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-emerald-500/50 hover:shadow-xl transition-all text-center">
                    <Stack direction="row" gap={4} align="center" justify="center" className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full mb-6 group-hover:scale-110 transition-transform">
                 ...
                 {/* GDPR / UU PDP */}
                 <Stack direction="col" gap={4} align="center" className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 hover:shadow-xl transition-all text-center">
                    <Stack direction="row" gap={4} align="center" justify="center" className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full mb-6 group-hover:scale-110 transition-transform">
                 ...
                 {/* PSE Kominfo */}
                 <Stack direction="col" gap={4} align="center" className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-red-500/50 hover:shadow-xl transition-all text-center">
                    <Stack direction="row" gap={4} align="center" justify="center" className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full mb-6 group-hover:scale-110 transition-transform">
                 ...
                 {/* SOC 2 Type II */}
                 <Stack direction="col" gap={4} align="center" className="h-full group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-purple-500/50 hover:shadow-xl transition-all text-center opacity-75">
                    <Stack direction="row" gap={4} align="center" justify="center" className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full mb-6">
        ...
        <section className="grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
           <div>
              <Stack direction="row" gap={2} align="center" className="px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
              ...
              <div className="lg:hidden">
                 <CardSlider mobileItemWidth="w-[85vw] sm:w-[400px]" breakpoint="lg">
                    <Stack direction="row" gap={4} className="p-4 border border-transparent hover:border-emerald-500/30 rounded-xl transition-colors">
                       <Stack direction="row" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600">
                    ...
                    <Stack direction="row" gap={4} className="p-4 border border-transparent hover:border-blue-500/30 rounded-xl transition-colors">
                       <Stack direction="row" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600">
                    ...
                    <Stack direction="row" gap={4} className="p-4 border border-transparent hover:border-amber-500/30 rounded-xl transition-colors">
                       <Stack direction="row" gap={4} align="center" justify="center" className="w-10 h-10 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-600">
           ...
           <Container className="relative w-full">
               ...
               <div className="aspect-square bg-slate-900 rounded-[2.5rem] p-6 sm:p-10 relative overflow-hidden shadow-2xl border border-slate-800">
                  ...
                  <Stack direction="col" gap={4} className="relative z-10 h-full justify-center">
                      <Stack direction="row" gap={4} align="center" justify="between" className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl">
                         <Stack direction="row" gap={3} align="center" className="text-emerald-400 text-xs">
                            <Globe className="w-4 h-4" /> Cloudflare WAF
                         </Stack>
                         <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse"></div>
                      </div>
                      <Stack direction="row" gap={4} align="center" justify="between" className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl ml-4 sm:ml-8">
                         <Stack direction="row" gap={3} align="center" className="text-blue-400 text-xs">
                            <Server className="w-4 h-4" /> Load Balancer
                         </Stack>
                         <div className="h-2 w-2 rounded-full bg-blue-500 animate-pulse"></div>
                      </div>
                      <Stack direction="row" gap={4} align="center" justify="between" className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 rounded-xl ml-8 sm:ml-16">
                         <Stack direction="row" gap={3} align="center" className="text-purple-400 text-xs">
                            <Lock className="w-4 h-4" /> App Server (Pod)
                         </Stack>
                         <div className="h-2 w-2 rounded-full bg-purple-500 animate-pulse"></div>
                      </div>
                      <Stack direction="row" gap={4} align="center" justify="between" className="bg-emerald-900/50 backdrop-blur border border-emerald-500/30 p-4 rounded-xl ml-12 sm:ml-24 shadow-[0_0_30px_rgba(16,185,129,0.2)]">
                         <Stack direction="row" gap={3} align="center" className="text-white text-xs font-bold">
