    ...
    <div className="bg-slate-50 dark:bg-slate-950 transition-colors font-sans selection:bg-emerald-500/30">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 bg-[#0B1120] text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          >
             <Button size="lg" className="bg-emerald-600 hover:bg-emerald-500 text-white border-none font-bold shadow-lg shadow-emerald-900/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-32">
        ...
        <section>
           <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Standar Kepatuhan Global</h2>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {/* ISO 27001 */}
              <div className="group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-emerald-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center">
                 ...
                 <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">ISO 27001</h3>
                 <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Information Security Management</p>
                 <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 text-[10px] font-bold uppercase tracking-wide">
                    Certified
                 </span>
              </div>

              {/* GDPR / UU PDP */}
              <div className="group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center">
                 <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <Globe className="w-8 h-8 text-slate-700 dark:text-slate-300 group-hover:text-blue-500 transition-colors" />
                 </div>
                 <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">GDPR & UU PDP</h3>
                 <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Data Privacy Compliance</p>
                 <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 text-[10px] font-bold uppercase tracking-wide">
                    Compliant
                 </span>
              </div>

              {/* PSE Kominfo */}
              <div className="group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-red-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center">
                 <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <FileCheck className="w-8 h-8 text-slate-700 dark:text-slate-300 group-hover:text-red-500 transition-colors" />
                 </div>
                 <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">PSE Kominfo</h3>
                 <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Terdaftar Resmi</p>
                 <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 text-[10px] font-bold uppercase tracking-wide">
                    Registered
                 </span>
              </div>

              {/* SOC 2 Type II */}
              <div className="group p-8 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-purple-500/50 hover:shadow-xl transition-all flex flex-col items-center text-center opacity-75">
                 <div className="w-16 h-16 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center mb-6">
                    <Lock className="w-8 h-8 text-slate-400" />
                 </div>
                 <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-2">SOC 2 Type II</h3>
                 <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Security Controls</p>
                 <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold uppercase tracking-wide">
                    In Progress
                 </span>
              </div>
           </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
           <div>
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Arsitektur Keamanan Berlapis</h2>
              ...
              <div className="space-y-6">
                 <div className="flex gap-4">
                    ...
                    <div>
                       <h3 className="font-bold text-slate-900 dark:text-white text-lg">Encryption at Rest & Transit</h3>
                 ...
                 <div className="flex gap-4">
                    ...
                    <div>
                       <h3 className="font-bold text-slate-900 dark:text-white text-lg">Infrastructure Isolation</h3>
                 ...
                 <div className="flex gap-4">
                    ...
                    <div>
                       <h3 className="font-bold text-slate-900 dark:text-white text-lg">24/7 Threat Monitoring</h3>
           ...
           <div className="relative">
               ...
               <div className="aspect-square bg-slate-900 rounded-[2.5rem] p-10 relative overflow-hidden shadow-2xl border border-slate-800">
        ...
        <section className="bg-slate-50 dark:bg-slate-900 rounded-[3rem] p-8 md:p-16 border border-slate-200 dark:border-slate-800">
           <div className="max-w-4xl mx-auto">
               <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8 text-center">Data Sub-processors</h2>
        ...
        <section className="text-center">
           <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">Butuh Dokumen Audit?</h2>
