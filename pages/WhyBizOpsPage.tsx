               ...
               <Container noPadding className="w-full lg:w-1/2 aspect-square relative bg-slate-50 dark:bg-slate-800/50 rounded-3xl shadow-inner border border-slate-200 dark:border-slate-700 p-8">
                  ...
                  <div className="absolute top-[15%] right-[15%] transform -translate-x-1/2 -translate-y-1/2 text-center z-10">
                     <div className="relative">
                        ...
                        <div className="w-20 h-20 bg-gradient-to-br from-primary-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold shadow-xl shadow-primary-500/30 mx-auto mb-3 text-2xl border-4 border-white dark:border-slate-800 gap-4">
                           B
                        </div>
                     </div>
                     ...
                     <CardSlider mobileItemWidth="w-[85vw] sm:w-[400px]">
                        ...
                        <div className="relative p-8 bg-gradient-to-br from-primary-50 to-white dark:from-primary-900/20 dark:to-slate-900 rounded-3xl border border-primary-100 dark:border-primary-800 shadow-lg h-full">
                           <div className="flex gap-5">
                              <div className="w-12 h-12 bg-primary-600 rounded-xl flex items-center justify-center text-white flex-shrink-0 font-bold text-xl shadow-lg shadow-primary-500/30 gap-4">3</div>
                              <div>
         ...
         <Container className="px-4 md:px-6 lg:px-8" size="7xl">
            ...
            <div className="md:hidden">
               <CardSlider mobileItemWidth="w-[85vw] sm:w-[350px]">
                  ...
                  {/* CTA Card */}
                  <div className="bg-slate-900 text-white p-8 rounded-2xl flex flex-col justify-center items-center text-center h-full shadow-xl relative overflow-hidden group min-h-[300px] gap-4">
                     ...
                     <Link to="/demo" className="relative z-10 w-full mt-auto">
                        <Button size="md" fullWidth className="bg-white text-slate-900 dark:text-white hover:bg-slate-100 border-none font-bold">Mulai Sekarang</Button>
                     </Link>
                  </div>
               </CardSlider>
            </div>
      ...
      <section className="py-32 bg-[#0B1120] text-white relative overflow-hidden">
         ...
         <Container size="4xl" className="relative z-10 text-center">
            ...
            <Stack direction="vertical" gap={6} className="justify-center">
               <Link to="/demo">
                  <Button size="lg" className="px-8 bg-white text-slate-900 dark:text-white hover:bg-slate-100 border-none font-bold text-lg shadow-xl hover:shadow-2xl transition-all w-full sm:w-auto">Mulai Transformasi Digital</Button>
               </Link>
               <Link to="/needs-analysis">
                  <Button size="lg" variant="outline" className="px-8 border-slate-700 text-slate-900 dark:text-white hover:bg-white/10 font-bold text-lg w-full sm:w-auto">Jadwalkan Audit Kebutuhan</Button>
               </Link>
            </Stack>
         </Container>
      </section>
